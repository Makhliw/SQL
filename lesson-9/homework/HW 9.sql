...
--TASK 3 
SELECT P.ProductID, S.SupplierName FROM Suppliers S 
JOIN Products AS P 
...
--TASK 8 
SELECT S.Name, E.EnrollmentID FROM Students S
JOIN Enrollments E
ON S.StudentID=E.StudentID
--TASK 9 
SELECT P.PaymentID, O.OrderID FROM Orders O
JOIN Payments P
ON P.OrderID=O.OrderID
--TASK 10
SELECT P.ProductName, Price, O.OrderID FROM Orders O
JOIN Products P
ON P.ProductID=O.ProductID
WHERE P.Price> 100
...
--TASK 16 
SELECT O.OrderID,Amount, O.TotalAmount FROM Orders O 
JOIN Payments P 
ON P.OrderID=O.OrderID
WHERE P.Amount<O.TotalAmount
--TASK 17 
SELECT E.Name, DepartmentName FROM Employees E 
JOIN Departments D 
ON D.DepartmentID=E.DepartmentID
ORDER BY E.NAME ASC 
--TASK 18 
...
--TASK 19 
SELECT C.FirstName, C.Country, S.SaleID FROM Customers C
JOIN SALES S 
ON S.CustomerID=C.CustomerID
WHERE C.Country = 'USA'
--TASK 20 
SELECT O.OrderID, FirstName, C.Country, O.TotalAmount FROM Orders O 
JOIN Customers C
ON C.CustomerID=O.CustomerID
...
--HARD LEVEL 
--TASK 21
SELECT e1.Name AS Employee1, e2.Name Employee2
FROM Employees e1
JOIN Employees e2 ON e1.EmployeeID < e2.EmployeeID
WHERE e1.DepartmentID<> e2.DepartmentID;
--task 22
select pay.PaymentID, pay.Amount, o.OrderID, o.Quantity, p.Price, (o.Quantity*p.Price) as COST from Payments as pay
join Orders as o 
...
--TASK 23
SELECT S.Name, S.StudentID FROM Students S
...
--TASK 24
SELECT EMP.Name AS EMPLOYEENAME, M.Name AS MANAGER, EMP.Salary AS EMPSALARY, M.Salary AS MANAGERSALARY FROM Employees AS EMP
JOIN Employees M
ON EMP.ManagerID=M.EmployeeID
WHERE M.Salary<=EMP.Salary
--TASK 25
SELECT C.FirstName, C.CustomerID, O.OrderID, P.Amount, O.TotalAmount FROM  ORDERS O 
