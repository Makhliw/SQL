...
--dql - data  query language - queries writing commands - ÷òåíèå äàííûõ (çàïðîñû) - select from 
--dml - data manipulation language  - upadating/deleting/inserting and etc - ðàáîòà ñ äàííûìè, èõ èçìåíåíèå, äîáàâëåíèå è òä 
--ddl - data definition language - creating or changing data - ñîçàäàíèå èëè èçìåíåíèå äàííûõ - create, alter, drop
--dcl - data controp language - assess control - óïðàâëåíèå äîñòóïîì - grand, revoke
--tcl - transaction control language - óïðàâëåíèå òðàíçàêöèÿìè - commit, rollback, savepoint
